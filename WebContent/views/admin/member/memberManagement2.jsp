       ...
       <div class="content">
        ...
        <div class="content_category_title"></div>
         ...
         <div class="content_detail">
            ...
            <%if(currentPage==1){ %>
            <%}else{ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/memManageSearch.me?keyword=<%=keyword %>&cate=<%=cate %>&currentPage=<%=currentPage - 1%>" style="color: black"><</a></li>
            <%} %>
			<%for(int p = startPage; p<=endPage; p++){ %>
				<%if(p!=currentPage){ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/memManageSearch.me?keyword=<%=keyword %>&cate=<%=cate %>&currentPage=<%=p%>" style="color: black"><%=p %></a></li>
			<%} else {%>     
