        ...
        <div class="content_category_title"></div>
         ...
         <div class="content_detail">
            ...
            <div id="search_area" style="margin-left:270px; margin-bottom:40px;">
                <form action="proManageSearch.pr" method="get">
            ...
            <%if(currentPage==1){ %>
            <%}else{ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/proManageSearch.pr?keyword=<%=keyword%>&currentPage=<%=currentPage - 1%>" style="color: black"><</a></li>
            <%} %>
			<%for(int p = startPage; p<=endPage; p++){ %>
				<%if(p!=currentPage){ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/proManageSearch.pr?keyword=<%=keyword%>&currentPage=<%=p%>" style="color: black"><%=p %></a></li>
			<%} else {%>     
