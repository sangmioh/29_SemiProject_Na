       ...
       <div class="content">
        ...
        <div class="content_category_title"></div>
         ...
         <div class="content_detail">
			...
			<form id="enroll-form" action="<%=contextPath%>/proUpdate.pr" method="post" enctype="multipart/form-data">
			<input type="hidden" name="proNo" value="<%=p.getProNo() %>">
                    <table>
                        <tr>
                            <th height="50px;" style="text-align: center;">제품명 </th>
                            <td colspan="3"><input type="text" name="title" style="width : 850px;" value="<%=p.getProName() %>" required> 
                        </tr>
                        <tr>
                        ...
                        <tr id="select1">
                            ...
                            <td><input type="number" name="price" min="10" max="999999"
                                    step="10" style="width : 150px;" value="<%=p.getPrice() %>" required>
                            ...
                            <script>
                            	$(function(){
                            		$('#select1 option[value=<%=p.getProEff()%>]').prop('selected', true);
                            	});
                            </script>
                        </tr>
                            <tr>
                            <th style="vertical-align:top; text-align: center;"><br>내용</th>
                                <td colspan="3">
                                    <textarea name="content" rows="20" style="width : 850px; resize:none;" required><%=p.getProDes() %></textarea>
                                </td>
                            ...
                            <tr id="select2">
                                ...
                                <td width="300"><input type="number" id="stock" name="stock"
                                    min="0" max="300" step="1" value="<%=p.getStock() %>" style="width : 100px;"></td>
                            ...
                            <script>
                            	$(function(){
                            		$('#select2 option[value=<%=p.getStatus()%>]').prop('selected', true);
                            	});
                            </script>                                       
                            </tr>    
                    </table> <br>
                        ...
                        <div id="contnent_3" align="right">
                            ...
                            <button onclick="location.href='<%=contextPath%>/proManageList.pr?currentPage=1'"  class="btn btn-dark btn-sm" >취소</button>
                        </div>
                </form>
