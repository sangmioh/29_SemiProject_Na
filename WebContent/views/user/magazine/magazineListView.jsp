					...
					<div id="content_4" class="paging-area" >
						<div id="page" class="page_nation" style="margin-left: 300px;" >
							<ul class="pagination" >
								<%if(currentPage==1){ %>
								<%}else{ %>
										<li class="page-item"><a class="page-link" href="<%=contextPath%>/list.mg?currentPage=<%=currentPage - 1%>" style="color: black"><</a></li>
								<%} %>
								<%for(int p = startPage; p<=endPage; p++){ %>
									<%if(p!=currentPage){ %>
										<li class="page-item"><a class="page-link" href="<%=contextPath%>/list.mg?currentPage=<%=p%>" style="color: black"><%=p %></a></li>
								<%} else {%>
