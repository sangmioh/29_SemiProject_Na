...
<%@ include file="../common/header.jsp" %>
       <div class="content">
           ...
           <div id="content_header">
            ...
            <form action="<%=contextPath%>/qnaupdate.in" method="post">
            <input type="hidden" name="ino" value="<%=q.getInqNo()%>">
                <table class="cd_table"  align="center">
                    <tr class="cd_table_title">
                        <td width="70px;">제목 : </td>
                        <td width="700px" height="150px"><input type="text" placeholder="제목을 입력하세요." name="title" value="<%=q.getInqTitle() %>"></td>
                    </tr>
                    <tr class="cd_table_content">
                        <td colspan="2">
                        	<div class="cd_table_content_title">문의내용</div>
                            <textarea cols="110" rows="10" style="resize:none" placeholder="내용을 입력하세요." name="content"><%=q.getInqQuery() %></textarea>
                        </td>
                    </tr>
                </table>
