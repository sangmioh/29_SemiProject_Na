<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, com.na.user.info.model.vo.Faq" %>
<%
           ...
           <div id="content_header">
                ...
                <div id="content_body2">
                    ...
                    <div class="content_detail">
                        <table class="cd_table table table-hover" align="center" style="text-align:center;">
                        <thead>
                            <tr>
                                <th width="80">글번호</th>
                                <th width="600">제목</th>
                        ...
                        <%for(Faq n : list) {%>
                            <tr onclick="location.href='<%=contextPath%>/detail.fa?fno=<%=n.getFaqNo()%>'">
                                <td><%=n.getFaqNo() %></td>
                                <td><%=n.getFaqTitle() %></td>
                            </tr>
                         <%} %>
