...
<%@ include file="../common/header.jsp" %>
      ...
      <!--content의 body영역-->
       <div class="content">
            ...
            <div id="pro_orderby">
                <div>
                <a href="<%=contextPath%>/proSearch2.pr?currentPage=1&s1=<%=s1%>&s2=<%=s2%>">신상품순  |  </a>
                <a href="<%=contextPath%>/proSearch21.pr?currentPage=1&s1=<%=s1%>&s2=<%=s2%>">높은가격순  |  </a>
                <a href="<%=contextPath%>/proSearch22.pr?currentPage=1&s1=<%=s1%>&s2=<%=s2%>">낮은가격순 </a>
                </div>
            </div>
            ...
            <%if(currentPage==1){ %>
            <%}else{ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/proSearch22.pr?s1=<%=s1%>&s2=<%=s2%>&currentPage=<%=currentPage - 1%>" style="color: black"><</a></li>
            <%} %>
			<%for(int p = startPage; p<=endPage; p++){ %>
				<%if(p!=currentPage){ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/proSearch22.pr?s1=<%=s1%>&s2=<%=s2%>&currentPage=<%=p%>" style="color: black"><%=p %></a></li>
			<%} else {%>     
