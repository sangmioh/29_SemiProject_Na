...
<%@ include file="../common/header.jsp" %>
      ...
      <!--content의 body영역-->
       <div class="content">
            ...
            <div id="pro_orderby">
                <div>
                <a href="<%=contextPath%>/proSearch.pr?keyword=<%=keyword%>&currentPage=1">신상품순  |  </a>
                <a href="<%=contextPath%>/proSearch12.pr?keyword=<%=keyword%>&currentPage=1">높은가격순  |  </a>
                <a href="<%=contextPath%>/proSearch13.pr?keyword=<%=keyword%>&currentPage=1">낮은가격순 </a>
                </div>
            </div>
            ...
            <%if(currentPage==1){ %>
            <%}else{ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/proSearch12.pr?keyword=<%=keyword%>&currentPage=<%=currentPage - 1%>" style="color: black"><</a></li>
            <%} %>
			<%for(int p = startPage; p<=endPage; p++){ %>
				<%if(p!=currentPage){ %>            
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/proSearch12.pr?keyword=<%=keyword%>&currentPage=<%=p%>" style="color: black"><%=p %></a></li>
			<%} else {%>     
