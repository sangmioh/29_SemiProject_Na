...
<body>
    ...
    <div class="jumbotron text-center" style="margin-bottom:0;" id="title">
     <div id="header_3">
               <div id="icon1">
                    <a id="cart_icon" href="<%=contextPath %>/mainMycart.my" target="" title="장바구니">
                ...
                <% if (loginUser == null ){ %> <!-- 로그인 전 -->
                   ...
                   <% } else  {%> 
                    ...
                    <ul id="login_ul">
                    	<li><a href="/na/beforinfo.my" id="mypage">마이페이지</a></li>
      ...
      <div class="container" style="margin-top:30px;">
        <div class="row">
          <div class="col-sm-8" style="margin-top : 50px">
            ...
            <div class="fakeimg" style="background-color: rgba(236, 250, 250, 0.0); border-radius: 10px;">
                <div id="p1">
                    <a href="/na/proDetail.pr?pno=8"><img src="/na/resources/image/오메가1.png"></a>
                </div>
                <div id="p2">
                    <a href="/na/proDetail.pr?pno=10"><img src="/na/resources/image/유산균1.png"></a>
                </div>
                <div id="p3">
                    <a href="/na/proDetail.pr?pno=2"><img src="/na/resources/image/비타민1.png"></a>
                </div>
            </div>
            ...
            <div class="fakeimg" style="margin-top: 30px; background-color: rgba(220, 219, 219, 0.2); border-radius: 10px;" >
                ...
                <div id="m2" style=" font-size: 14px; text-align: left; margin-left : 10px">
                    <a href="/na/detail.mg?mno=115" style="text-decoration: none; color: black;">
                ...
                <div id="m3">
                    <a href="/na/detail.mg?mno=115"><img src="/na/resources/image/ma1.JPG" style="width : 180px; height : 160px; border-radius: 10px; margin-top:20px;"></a>
                </div>
            </div>
          </div>

          <div class="wrap" style="float:right;text-align:center;">
            ...
            <li class="a active" style="height : 60px; padding-top : 20px;">
                <a class="b" href="<%= contextPath%>/reviewDetail.re?rno=324" style="margin:auto; font-size:17px; padding-top:20px"> NO15. 오메가3를 먹은 이후로  </a>
            </li>
            <li class="a" style="height : 60px;  padding-top : 20px;">
                <a class="b" href="<%= contextPath%>/reviewDetail.re?rno=346" style="margin:auto; font-size:17px;"> NO37. 쾌변엔 프로바이오틱스!! </a>
            </li>
            <li class="a" style="height : 60px; padding-top : 20px;">
                <a class="b" href="<%= contextPath%>/reviewDetail.re?rno=330" style="margin:auto; font-size:17px;"> NO21. 비타민B 먹고 천리안 됐어요  </a>
            </li>
            </ul>

            <h5 style="text-align: center; color :rgba(3, 50, 63, 0.7); font-weight: bold;">뉴올 영양제 FAQ</h3>
            <div class="fakeimg">
                <a href="/na/detail.fa?fno=6"><img class="slide1" src="/na/resources/image/main_img1.jpg" style="width : 100%; height : 100%;"></a>
                <a href="/na/detail.fa?fno=7"><img class="slide1" src="/na/resources/image/main_img2.jpg" style="width : 100%; height : 100%;"></a>
                <a href="/na/detail.fa?fno=8"><img class="slide1" src="/na/resources/image/main_img3.jpg" style="width : 100%; height : 100%;"></a>
                <a href="/na/detail.fa?fno=9"><img class="slide1" src="/na/resources/image/main_img4.jpg" style="wid	th : 100%; height : 100%;"></a>
                <a href="/na/detail.fa?fno=10"><img class="slide1" src="/na/resources/image/main_img5.jpg" style="width : 100%; height : 100%;"></a>
            </div>
            <br>
        ...
        <table>
            ...
            <tr>
                <td id="ft1">
                   <a href="/na/contract.in" >이용약관</a>  |
                   <a href="/na/contract.in" >개인정보취급방침</a>  
                </td>
                <td id="ft2">
                   <a href="/na/noticeList.no?currentPage=1">고객센터</a>
                </td>
            </tr>
           <tr>
               <td>&nbsp;</td>
