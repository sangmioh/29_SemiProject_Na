...
/**
 * Servlet implementation class ProductListView2Controller
 */
@WebServlet("/proList2.pr")
public class ProductListView2Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductListView2Controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> list = new ProductService().selectList2(pi);
		
		request.setAttribute("list", list);
		request.setAttribute("pi", pi);
		request.getRequestDispatcher("views/user/product/proList2.jsp").forward(request, response);
