...
public class NoticeListViewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new InfoService().selectNoticeCount();
		...
		ArrayList<Notice> list = new InfoService().selectNoticeList(pi);
		
		request.setAttribute("list", list);
		request.setAttribute("pi", pi);
		request.getRequestDispatcher("views/user/info/notice.jsp").forward(request, response);
