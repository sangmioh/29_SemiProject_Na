...
/**
 * Servlet implementation class MagazineList2Controller
 */
@WebServlet("/list2.mg")
public class MagazineList2Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MagazineList2Controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Magazine> list = new MagazineService().selectList2(pi);
		...
		request.getRequestDispatcher("views/user/magazine/magazineListView2.jsp").forward(request, response);
