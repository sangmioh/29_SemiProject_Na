...
/**
 * Servlet implementation class ProductManageViewController
 */
@WebServlet("/proManageList.pr")
public class ProductManageViewController extends HttpServlet {
...
//		System.out.println(list);
		...
		request.getRequestDispatcher("views/admin/product/productManagement.jsp").forward(request, response);
