...
/**
 * Servlet implementation class ProductManageSearchController
 */
@WebServlet("/proManageSearch.pr")
public class ProductManageSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductManageSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/product/productManagement2.jsp").forward(request, response);
